          ...
          >
            ...
            <div className="space-y-1">
              ...
              <motion.h1
                ...
                className="font-gued font-bold text-6xl sm:text-7xl md:text-8xl lg:text-[6.5rem] tracking-tight text-text-main leading-[0.95]"
              >
                Gagan<span className="text-primary font-bold">.</span>
              </motion.h1>
